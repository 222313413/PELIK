...
required_packages <- c("shiny", "shinydashboard", "DT", "plotly", 
                       ...
                       "htmltools", "fresh", "scales", "tidyr", "sf", "stringr", "fontawesome")
...
data_lahan <- read_excel("D:/PELIK/data/data.xlsx") # Jalankan fungsi pembuatan data
...
ui <- dashboardPage(
  ...
  dashboardHeader(
    title = tags$a(href="#", # href="#" agar tetap clickable namun tidak mengarah ke mana-mana
                   tags$img(
...
.analysis-warning {
    ...
    tabItems(
      ...
      tabItem(tabName = "data", h2("📋 Dataset Lengkap", class = "page-title-kanit"), div(class = "description-box", h4("📖 Deskripsi Dataset", class = "section-title-kanit"), p("Semua data berasal dari hasil olahan dan kompilasi dari berbagai sumber terpercaya, mencakup periode 2014 hingga 2023. Data ini disimulasikan untuk tujuan demonstrasi dashboard.", style = "margin-bottom: 10px; font-family: 'Poppins', sans-serif;"), tags$ul(style = "margin-left: 20px; color: #4a5568; font-family: 'Poppins', sans-serif;", tags$li("🏛 Kementerian Lingkungan Hidup dan Kehutanan (KLHK) - Data tutupan lahan Indonesia."), tags$li("📊 Data tutupan lahan Indonesia (2014–2023)"), tags$li("💨 Data estimasi emisi karbon (CO₂e) dari Global Forest Watch")), p("Silakan akses tautan berikut untuk informasi lebih lanjut mengenai sumber data:", style = "margin-top: 15px; margin-bottom: 8px; font-family: 'Poppins', sans-serif;"), tags$ul(style = "margin-left: 20px; font-family: 'Poppins', sans-serif;", tags$li(tags$a("Data Tutupan Lahan: KLHK – Tutupan Lahan", href = "https://statistik.menlhk.go.id/sisklhk/ditjen_ppkl", target = "_blank", style = "color: #667eea;")), tags$li(tags$a("Estimasi Emisi: Global Forest Watch", href = "https://www.globalforestwatch.org/dashboards/country/IDN/?lang=id",target = "_blank", style = "color: #667eea;")))), 
              fluidRow(
                box(width = 3, title = "🔍 Filter Data", status = "primary", solidHeader = TRUE, selectInput("kategori_data", "Pilih Kategori Data:", choices = list("Semua Data" = "all", "Total Luas Penutupan Hutan (Ha)" = "Luas_Hutan", "Total Luas Penutupan Non-Hutan (Ha)" = "Luas_Non_Hutan", "Luas Kehilangan Tutupan Pohon (Ha)" = "Kehilangan_Tutupan", "Estimasi Emisi Karbon (Ton CO₂e)" = "Emisi_Karbon")))),
              fluidRow(
                box(width = 12, title = "📊 Tabel Data Interaktif", status = "success", solidHeader = TRUE, div(style = "margin-bottom: 15px;", h5("📈 Kolom Data:", class = "subtitle-kanit"), p("No • Provinsi • Pulau • Tahun • Luas Hutan (Ha) • Luas Non-Hutan (Ha) • Luas Kehilangan Tutupan Pohon (Ha) • Estimasi Emisi Karbon (Ton CO₂e)", style = "font-size: 12px; color: #718096; font-style: italic; font-family: 'Poppins', sans-serif;")), DT::dataTableOutput("tabel_data")))),
                                         ...
                                         column(12,
                                                box(width = NULL,
                                                    ...
                                                    div(style = "text-align: center; padding: 20px;",
                                                        ...
                                                        # Video iframe - ganti URL dengan link video Anda
                                                        tags$iframe(
                                                          src = "https://www.youtube.com/embed/-4K3eAmsvhs?rel=0&showinfo=0&modestbranding=1", 
                                                          width = "100%",
                                                          height = "400",
                                                          frameborder = "0",
                                                        ...
                                                        # Alternatif jika menggunakan video lokal
                                                        # tags$video(
                                                        ...
                                                        p("Durasi: ~5 menit | Bahasa: Indonesia", 
                                                          style = "font-size: 14px; color: #718096; margin-top: 15px; font-family: 'Poppins', sans-serif;")
                                                    )
                                                )
                                         )
                                       ),
...
server <- function(input, output, session) {
  ...
  # TAMBAHAN: Server logic untuk Analisis Statistik
  
  # SERVER LOGIC UNTUK ANALISIS STATISTIK
  # Bagian ini ditambahkan ke dalam fungsi server() utama
